...
static const CGFloat Ksize = 40.f;
static const CGFloat KLineWidth = 3.f;

@interface GZYCircleLoadingView()
...
@implementation GZYCircleLoadingView
...
- (void)setupAnimation{
    ...
    circle1.strokeColor = [UIColor cyanColor].CGColor;
