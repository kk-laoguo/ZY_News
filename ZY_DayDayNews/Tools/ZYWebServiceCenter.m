...
#import "ZYWebServiceCenter.h"
#import "AFNetworking.h"
#define certificate @"jysoft"

@implementation ZYWebServiceCenter
...
+ (void)getWithUrl:(NSString *)urlStr paraDic:(NSDictionary *)paraDic successBlock:(requestSuccessBlock)successBlock failedBlock:(requestFailedBlock)failedBlock
{
    ...
    // 加上这行代码，https ssl 验证。
    if(openHttpsSSL){
        [manager setSecurityPolicy:[ZYWebServiceCenter customSecurityPolicy]];
    } else {
...
{
    [ZYWebServiceCenter uploadFileWithUrl:urlStr param:dic serviceName:imgParaName fileName:@"0.png" mimeType:@"image/jpeg" fileData:data successBlock:successBlock failedBlock:failedBlock];
}
...
+(void)uploadMultipleImageWithUrl:(NSString *)urlStr param:(NSDictionary *)dic imgParaNameArr:(NSArray *)imgParaNameArr imgDataArr:(NSArray *)dataArr successBlock:(requestSuccessBlock)successBlock failedBlock:(requestFailedBlock)failedBlock
{
    ...
    [ZYWebServiceCenter uploadFileWithUrl:urlStr param:dic serviceNameArr:imgParaNameArr fileNameArr:fileNameArr mimeType:@"image/jpeg" fileDataArr:dataArr successBlock:successBlock failedBlock:failedBlock];
}
